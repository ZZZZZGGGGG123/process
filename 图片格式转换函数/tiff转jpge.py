...
if __name__ == "__main__":
    input_folder = r"D:\简化\裁剪后\image"  # Replace with the path to the folder containing TIFF images
    output_folder = r"D:\简化\裁剪后\image_jpg"  # Replace with the path to the folder where you want to save JPEG images
